                    ...
                    <div>
                        ...
                        <nav aria-label="Program navigation">
                            <ul className="space-y-2 text-gray-300">
                                <li><a href="/program/kelas-alam" className="hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 rounded transition-colors">Kelas Alam</a></li>
                                <li><a href="/program/bebersih-bareng" className="hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 rounded transition-colors">#BebersihBareng</a></li>
                                <li><a href="/program/ecobrick" className="hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 rounded transition-colors">Ecobrick</a></li>
                                <li><a href="/program/fotografi" className="hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 rounded transition-colors">Fotografi</a></li>
                            </ul>
                        </nav>
                    </div>
